...
def generateControllerConfig(system: Emulator, playersControllers: Controllers, metadata: Mapping[str, str], wheels: DeviceInfoMapping, rom: Path, guns: Guns) -> None:
    ...
    if system.name == "wii":
        if system.config.use_guns and guns:
            ...
            or ".tn." in rom.name
            or ".nt." in rom.name
            or ".udraw." in rom.name
            or ".tatacon." in rom.name
            or ".guitar." in rom.name
            or ".drumsrb." in rom.name
            or ".drumsgh." in rom.name
            or ".ds." in rom.name
            or ".tt." in rom.name
        ) or "sideWiimote" in system.config:
...
def generateControllerConfig_emulatedwiimotes(system: Emulator, playersControllers: Controllers, wheels: DeviceInfoMapping, rom: Path) -> None:
    ...
    if controller_mode is system.config.MISSING:
        controller_mode = "disabled"
    rom_name = rom.name.lower()

    def mode_or_tag(modes: tuple[str, ...], tags: tuple[str, ...]) -> bool:
        return controller_mode in modes or any(tag in rom_name for tag in tags)

    # Special extension profiles first
    if mode_or_tag(("udraw",), (".udraw.",)):
        extraOptions["Extension"] = "uDraw"
        wiiMapping['b'] = 'uDraw/Touch/Pressure'
        wiiMapping['a'] = 'uDraw/Touch/Lift'
        wiiMapping['joystick1up'] = 'uDraw/Stylus/Up'
        wiiMapping['joystick1left'] = 'uDraw/Stylus/Left'
        wiiMapping['pagedown'] = 'uDraw/Buttons/Rocker Up'
        wiiMapping['pageup'] = 'uDraw/Buttons/Rocker Down'
    elif mode_or_tag(("tatacon",), (".tatacon.",)):
        extraOptions["Extension"] = "TaTaCon"
        wiiMapping['l2'] = 'TaTaCon/Center/Left'
        wiiMapping['r2'] = 'TaTaCon/Center/Right'
        wiiMapping['pageup'] = 'TaTaCon/Rim/Left'
        wiiMapping['pagedown'] = 'TaTaCon/Rim/Right'
    elif mode_or_tag(("guitar",), (".guitar.",)):
        extraOptions["Extension"] = "Guitar"
        wiiMapping['b'] = 'Guitar/Frets/Green'
        wiiMapping['pageup'] = 'Guitar/Frets/Red'
        wiiMapping['pagedown'] = 'Guitar/Frets/Yellow'
        wiiMapping['r2'] = 'Guitar/Frets/Blue'
        wiiMapping['y'] = 'Guitar/Frets/Orange'
        wiiMapping['l2'] = 'Guitar/Strum/Up'
        wiiMapping['select'] = 'Guitar/Buttons/-'
        wiiMapping['start'] = 'Guitar/Buttons/+'
        wiiMapping['up'] = 'Guitar/Stick/Up'
        wiiMapping['down'] = 'Guitar/Stick/Down'
        wiiMapping['left'] = 'Guitar/Stick/Left'
        wiiMapping['right'] = 'Guitar/Stick/Right'
        wiiMapping['joystick1left'] = 'Guitar/Whammy/Bar'
    elif mode_or_tag(("drumsrb",), (".drumsrb.",)):
        extraOptions["Extension"] = "Drums"
        wiiMapping['l2'] = 'Drums/Pads/Red'
        wiiMapping['pageup'] = 'Drums/Pads/Yellow'
        wiiMapping['pagedown'] = 'Drums/Pads/Blue'
        wiiMapping['r2'] = 'Drums/Pads/Green'
        wiiMapping['joystick1left'] = 'Drums/Pads/Bass'
        wiiMapping['select'] = 'Drums/Buttons/-'
        wiiMapping['start'] = 'Drums/Buttons/+'
        wiiMapping['up'] = 'Drums/Stick/Up'
        wiiMapping['down'] = 'Drums/Stick/Down'
        wiiMapping['left'] = 'Drums/Stick/Left'
        wiiMapping['right'] = 'Drums/Stick/Right'
    elif mode_or_tag(("drumsgh",), (".drumsgh.",)):
        extraOptions["Extension"] = "Drums"
        wiiMapping['l2'] = 'Drums/Pads/Red'
        wiiMapping['pageup'] = 'Drums/Pads/Yellow'
        wiiMapping['pagedown'] = 'Drums/Pads/Blue'
        wiiMapping['r2'] = 'Drums/Pads/Orange'
        wiiMapping['b'] = 'Drums/Pads/Green'
        wiiMapping['joystick1left'] = 'Drums/Pads/Bass'
        wiiMapping['select'] = 'Drums/Buttons/-'
        wiiMapping['start'] = 'Drums/Buttons/+'
        wiiMapping['up'] = 'Drums/Stick/Up'
        ...
        wiiMapping['left'] = 'Drums/Stick/Left'
        wiiMapping['right'] = 'Drums/Stick/Right'
    elif mode_or_tag(("drawsome",), (".ds.",)):
        extraOptions["Extension"] = "Drawsome"
        wiiMapping['b'] = 'Drawsome/Touch/Pressure'
        wiiMapping['a'] = 'Drawsome/Touch/Lift'
        wiiMapping['joystick1up'] = 'Drawsome/Stylus/Up'
        wiiMapping['joystick1left'] = 'Drawsome/Stylus/Left'
    elif mode_or_tag(("turntable",), (".tt.",)):
        extraOptions["Extension"] = "Turntable"
        wiiMapping['pageup'] = 'Turntable/Buttons/Green Left'
        wiiMapping['pagedown'] = 'Turntable/Buttons/Red Left'
        wiiMapping['y'] = 'Turntable/Buttons/Blue Left'
        wiiMapping['select'] = 'Turntable/Buttons/-'
        wiiMapping['start'] = 'Turntable/Buttons/+'
        wiiMapping['joystick1left'] = 'Turntable/Table Left/Left'
        wiiMapping['up'] = 'Turntable/Stick/Up'
        wiiMapping['down'] = 'Turntable/Stick/Down'
        wiiMapping['left'] = 'Turntable/Stick/Left'
        wiiMapping['right'] = 'Turntable/Stick/Right'
        wiiMapping['l3'] = 'Turntable/Effect/Left'
        wiiMapping['r3'] = 'Turntable/Effect/Right'
        wiiMapping['l2'] = 'Turntable/Crossfade/Left'
        wiiMapping['r2'] = 'Turntable/Crossfade/Right'
    # cc : Classic Controller Settings / pro/ccp : Classic Controller Pro settings
    elif mode_or_tag(("cc", "pro", "ccp"), (".cc.", ".pro.", ".ccp.")):
        ...
        # Side wiimote
        if mode_or_tag(("side",), (".side.",)):
            extraOptions["Options/Sideways Wiimote"] = "1"
            wiiMapping['x'] = 'Buttons/A'
            wiiMapping['y'] = 'Buttons/1'
            wiiMapping['b'] = 'Buttons/2'
            wiiMapping['a'] = 'Buttons/B'
            wiiMapping['l2'] = 'Shake/Z'
            wiiMapping['select'] = 'Buttons/-'
            wiiMapping['start'] = 'Buttons/+'
            wiiMapping['pageup'] = 'Tilt/Left'
            wiiMapping['pagedown'] = 'Tilt/Right'

        # i: infrared, s: swing, t: tilt, n: nunchuk
        # 12 possible combinations : is si / it ti / in ni / st ts / sn ns / tn nt
        if mode_or_tag(("is", "it", "in"), (".is.", ".it.", ".in.")):
            wiiMapping['joystick1up'] = 'IR/Up'
            wiiMapping['joystick1left'] = 'IR/Left'
            wiiMapping['l3'] = 'IR/Relative Input Hold'
        if mode_or_tag(("si", "ti", "ni"), (".si.", ".ti.", ".ni.")):
            wiiMapping['joystick2up'] = 'IR/Up'
            wiiMapping['joystick2left'] = 'IR/Left'
            wiiMapping['r3'] = 'IR/Relative Input Hold'

        if mode_or_tag(("si", "st", "sn"), (".si.", ".st.", ".sn.")):
            wiiMapping['joystick1up'] = 'Swing/Up'
            wiiMapping['joystick1left'] = 'Swing/Left'
        if mode_or_tag(("is", "ts", "ns"), (".is.", ".ts.", ".ns.")):
            wiiMapping['joystick2up'] = 'Swing/Up'
            wiiMapping['joystick2left'] = 'Swing/Left'

        if mode_or_tag(("ti", "ts", "tn"), (".ti.", ".ts.", ".tn.")):
            wiiMapping['joystick1up'] = 'Tilt/Forward'
            wiiMapping['joystick1left'] = 'Tilt/Left'
            wiiMapping['l3'] = 'Tilt/Modifier'
        if mode_or_tag(("it", "st", "nt"), (".it.", ".st.", ".nt.")):
            wiiMapping['joystick2up'] = 'Tilt/Forward'
            wiiMapping['joystick2left'] = 'Tilt/Left'
            wiiMapping['r3'] = 'Tilt/Modifier'

        if mode_or_tag(("ni", "ns", "nt"), (".ni.", ".ns.", ".nt.")) or system.config.get_bool("dsmotion"):
            extraOptions['Extension'] = 'Nunchuk'
            wiiMapping['l1'] = 'Nunchuk/Buttons/C'
            wiiMapping['r1'] = 'Nunchuk/Buttons/Z'
            wiiMapping['joystick1up'] = 'Nunchuk/Stick/Up'
            wiiMapping['joystick1left'] = 'Nunchuk/Stick/Left'
            wiiMapping['l3'] = 'Nunchuk/Stick/Modifier'
            wiiMapping['select'] = 'Buttons/-'
            wiiMapping['start'] = 'Buttons/+'
            if system.config.get_bool("nunchuk_swing"):
                wiiMapping['l2'] = 'Nunchuk/Swing/Forward'
            else:
                wiiMapping['l2'] = 'Nunchuk/Shake/Z'
            wiiMapping['r2'] = 'Shake/Z'

        if mode_or_tag(("in", "sn", "tn"), (".in.", ".sn.", ".tn.")):
            extraOptions['Extension'] = 'Nunchuk'
            wiiMapping['l1'] = 'Nunchuk/Buttons/C'
            wiiMapping['r1'] = 'Nunchuk/Buttons/Z'
            wiiMapping['joystick2up'] = 'Nunchuk/Stick/Up'
            wiiMapping['joystick2left'] = 'Nunchuk/Stick/Left'
            wiiMapping['r3'] = 'Nunchuk/Stick/Modifier'
            wiiMapping['select'] = 'Buttons/-'
            wiiMapping['start'] = 'Buttons/+'
            wiiMapping['l2'] = 'Shake/Z'
            if system.config.get_bool("nunchuk_swing"):
                wiiMapping['r2'] = 'Nunchuk/Swing/Forward'
            else:
                wiiMapping['r2'] = 'Nunchuk/Shake/Z'
...
def generateControllerConfig_any_auto(f: codecs.StreamReaderWriter, pad: Controller, anyMapping: Mapping[str, str | None], anyReverseAxes: Mapping[str | None, str], anyReplacements: Mapping[str, str] | None, extraOptions: Mapping[str, str], system: Emulator, nplayer: int, nsamepad: int) -> None:
    ...
    for x in pad.inputs:
        ...
        if system.name == "wii":
            wii_deadzone = system.config.get("dolphin_wii_deadzone", "15.0")
            f.write(f"Classic/Right Stick/Dead Zone = {wii_deadzone}\n")
            f.write(f"Classic/Left Stick/Dead Zone = {wii_deadzone}\n")
            f.write(f"IR/Dead Zone = {wii_deadzone}\n")
            f.write(f"Tilt/Dead Zone = {wii_deadzone}\n")
            f.write(f"Swing/Dead Zone = {wii_deadzone}\n")
            f.write(f"IMUGyroscope/Dead Zone = {wii_deadzone}\n")
            f.write(f"Nunchuk/Tilt/Dead Zone = {wii_deadzone}\n")
            f.write(f"Nunchuk/Swing/Dead Zone = {wii_deadzone}\n")
            f.write(f"Nunchuk/Stick/Dead Zone = {wii_deadzone}\n")

            wii_sensitivity = system.config.get("dolphin_wii_sensitivity", "100.0")
            f.write(f"IR/Up/Range = {wii_sensitivity}\n")
            f.write(f"IR/Down/Range = {wii_sensitivity}\n")
            f.write(f"IR/Left/Range = {wii_sensitivity}\n")
            f.write(f"IR/Right/Range = {wii_sensitivity}\n")
            f.write(f"Tilt/Forward/Range = {wii_sensitivity}\n")
            f.write(f"Tilt/Left/Range = {wii_sensitivity}\n")
            f.write(f"Tilt/Backward/Range = {wii_sensitivity}\n")
            f.write(f"Tilt/Right/Range = {wii_sensitivity}\n")
            f.write(f"Swing/Up/Range = {wii_sensitivity}\n")
            f.write(f"Swing/Down/Range = {wii_sensitivity}\n")
            f.write(f"Swing/Left/Range = {wii_sensitivity}\n")
            f.write(f"Swing/Right/Range = {wii_sensitivity}\n")
            f.write(f"Nunchuk/Stick/Up/Range = {wii_sensitivity}\n")
            f.write(f"Nunchuk/Stick/Down/Range = {wii_sensitivity}\n")
            f.write(f"Nunchuk/Stick/Left/Range = {wii_sensitivity}\n")
            f.write(f"Nunchuk/Stick/Right/Range = {wii_sensitivity}\n")
            f.write(f"Classic/Left Stick/Up/Range = {wii_sensitivity}\n")
            f.write(f"Classic/Left Stick/Down/Range = {wii_sensitivity}\n")
            f.write(f"Classic/Left Stick/Left/Range = {wii_sensitivity}\n")
            f.write(f"Classic/Left Stick/Right/Range = {wii_sensitivity}\n")
            f.write(f"Classic/Right Stick/Up/Range = {wii_sensitivity}\n")
            f.write(f"Classic/Right Stick/Down/Range = {wii_sensitivity}\n")
            f.write(f"Classic/Right Stick/Left/Range = {wii_sensitivity}\n")
            f.write(f"Classic/Right Stick/Right/Range = {wii_sensitivity}\n")

            f.write(f"IR/Auto-Hide = {'True' if system.config.get_bool('wii_hidecursor') else 'False'}\n")
            f.write(f"IR/Relative Input = {'False' if system.config.get_bool('wii_relativecursor') else 'True'}\n")
        # JS gate size
